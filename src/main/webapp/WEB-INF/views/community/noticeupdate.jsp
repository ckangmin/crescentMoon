                ...
                <form action="./notice.html" method="get">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="title" name="title" value="수정하기 전 제목">
                        </div>
                    </div><!--제목-->
                    ...
                    <div class="row my-3">
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" id="content" name="content" rows="10"> 수정하기 전 내용 </textarea>
                        </div>
                    </div><!--내용-->

                    <div class="row">
                        <div class="col-md-12 text-center mb-3">
                            <button class="btn btn-success mr-5" type="submit"><h5 id="h5Btn">수정하기</h4></button>
